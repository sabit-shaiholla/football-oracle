...
public class UserPlayerReviewController {
    ...
    @PostMapping
    public ResponseEntity<UserPlayerReviewDto> createReview(@RequestBody UserPlayerReviewRequest reviewRequest,
                                                            @AuthenticationPrincipal UserDetails userDetails){
        UserPlayerReviewDto createdReview = userPlayerReviewService.createReview(reviewRequest, userDetails.getUsername());
    ...
    public ResponseEntity<UserPlayerReviewDto> updateReview(@PathVariable Integer reviewId,
                                                            ...
                                                            @AuthenticationPrincipal UserDetails userDetails){
        UserPlayerReviewDto updatedReview = userPlayerReviewService.updateReview(reviewId, reviewRequest, userDetails.getUsername());
        return ResponseEntity.ok(updatedReview);
    }

    @GetMapping
    public ResponseEntity<List<UserPlayerReviewDto>> getReviewsByUser(@AuthenticationPrincipal UserDetails userDetails) {
        List<UserPlayerReviewDto> reviews = userPlayerReviewService.getReviewsByUser(userDetails.getUsername());
